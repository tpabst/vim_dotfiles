...
if s:style == "light"
    ...
    if s:contrast == "low"
        ...
        hi PmenuSbar    guifg=#9e9e9e   guibg=#9e9e9e
        ...
        hi FoldColumn   guifg=#9e9e9e
        hi Folded       guifg=#9e9e9e
        hi Pmenu                        guibg=#808080
        hi PmenuSbar    guifg=#808080   guibg=#444444
        hi PmenuThumb                   guibg=#080808
        hi SignColumn   guifg=#9e9e9e
    ...
    hi CursorLineNr guifg=#ffff5f   guibg=#444444
    hi FoldColumn                   guibg=#1c1c1c
    hi Folded                       guibg=#4e4e4e
    hi LineNr       guifg=#767676   guibg=#080808
